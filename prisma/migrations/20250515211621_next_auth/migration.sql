/*
  ...
  - You are about to drop the `LoginTokens` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Users` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "BookmarkedMovies" DROP CONSTRAINT "BookmarkedMovies_userId_fkey";
...
-- DropForeignKey
ALTER TABLE "LoginTokens" DROP CONSTRAINT "LoginTokens_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "BookmarkedMovies" ADD CONSTRAINT "BookmarkedMovies_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
